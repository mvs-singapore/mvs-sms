...
RSpec.describe Student, type: :model do
  ...
  describe "new student" do
    it 'should have default status' do
      ...
      expect(new_student.reload.status).to eq 'New Admission'
    end
  end
...
Ah Hock,Li,2017,16006/2016,2017-10-02,Class 1.1 (2016),New Admission,2000-05-06,Singapore,Chinese,S80888888D,Singaporean,male,12345/234,Autistic,Epilepsy,Antihistamines,Peanuts,association_of_persons_with_special_needs
'
    end
  end
end
