...
%w[super_admin teacher principal vice_principal clerk case_worker].each do |role_str|
...
if Rails.env.development?
  ...
  30.times do
    student = Student.create(admission_year: Faker::Number.between(2014, 2017),
                             ...
                             nric: "T#{Faker::Number.between(1000000, 9999999)}#{%w[C D E F G H K J X Z].sample}",
    ...
    student.past_education_records.create(
      ...
      to_date: Date.today,
      qualification: %w(PSLE Certificate).sample,
