  ...
  def student_params
    student_params = params.require(:student)
                           .permit(:admission_year, :admission_no, :registered_at, :current_class, :status, :referred_by, :referral_notes,
                                   ...
                                   point_of_contacts_attributes: %i[id salutation surname given_name address postal_code race dialect languages_spoken id_number id_type date_of_birth place_of_birth nationality occupation home_number handphone_number office_number relationship _destroy],
